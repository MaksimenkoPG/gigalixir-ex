...
# GigalixirExWeb.Endpoint.init/2 when load_from_system_env is
...
config :gigalixir_ex, GigalixirExWeb.Endpoint,
  ...
  url: [host: "strict-round-scorpion.gigalixirapp.com", port: 80],
...
# start per endpoint:
#
#     config :gigalixir_ex, GigalixirExWeb.Endpoint, server: true
#
